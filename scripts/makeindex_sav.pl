#!/usr/bin/perl
#
# $Source: C:/project/openehr/spec-dev/scripts/SCCS/s.makeindex_sav.pl $
# $Date: 04/01/07 16:33:57+10:00 $
# $Revision: 1.1 $
#
...
sub extract_data_from_file {
  ...
  print "LINE ---- $line ---- \n";
	...
	$line_no++;
      ...
      die "Error: $filename: unexpected format in line $line_no\n";
    }
  }
