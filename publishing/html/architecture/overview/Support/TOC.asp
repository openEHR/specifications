...
<table width="331" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><img src="images/navprevx.gif" width="81" height="23" border="0" alt="PREV"> </td>
    <td><a href="$PAGENEXT(html, name, $CHARSET;);"><img src="images/navnext.gif" width="81" height="23"
    border="0" alt="NEXT"> </a></td>
    <td><a href="$PAGELAST(html, name, $CHARSET;);"><img src="images/navidx.gif" width="85" height="23"
