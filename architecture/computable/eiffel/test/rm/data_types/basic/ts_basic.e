indexing
	...
	keywords:    "test, basic, boolean, state"
	...
	file:        "$Source: C:/project/openehr/spec-dev/architecture/computable/eiffel/test/rm/data_types/basic/SCCS/s.ts_basic.e $"
	revision:    "$Revision$"
	last_change: "$Date$"
...
--| License.
--|
--| The Original Code is ts_basic.e.
--|
