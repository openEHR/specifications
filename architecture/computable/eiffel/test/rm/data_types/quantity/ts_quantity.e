...
feature -- Access
	...
	test_cases: LINKED_LIST[TEST_CASE] is
		once
			create Result.make
			Result.extend(create {TC_DV_QUANTITY}.make(Void))
			Result.extend(create {TC_DV_QUANTITY_RATIO}.make(Void))
...
--| License.
--|
--| The Original Code is ts_quantity.e.
--|
