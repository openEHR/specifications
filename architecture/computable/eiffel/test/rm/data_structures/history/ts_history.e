indexing
	...
	file:        "$Source: C:/project/openehr/spec-dev/architecture/computable/eiffel/test/rm/data_structures/history/SCCS/s.ts_history.e $"
	revision:    "$Revision$"
	last_change: "$Date$"
...
--| License.
--|
--| The Original Code is ts_history.e.
--|
