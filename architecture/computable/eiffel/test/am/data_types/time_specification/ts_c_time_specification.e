indexing
	...
	file:        "$Source: C:/project/openehr/spec-dev/architecture/computable/eiffel/test/am/data_types/time_specification/SCCS/s.ts_c_time_specification.e $"
	revision:    "$Revision: 1.2 $"
	last_change: "$Date: 04/03/19 14:22:38+10:00 $"

class TS_C_TIME_SPECIFICATION
...
feature -- Access
	...
	test_cases: LINKED_LIST[TEST_CASE] is
		...
		once
			create Result.make
			create {TC_C_DV_GENERAL_TIME_SPECIFICATION} tc.make(Void) 		Result.extend(tc)
...
--| License.
--|
--| The Original Code is ts_c_time_specification.e.
--|
