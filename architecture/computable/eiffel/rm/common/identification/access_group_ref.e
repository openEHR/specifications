indexing
	...
	file:        "$Source: C:/project/openehr/spec-dev/architecture/computable/eiffel/rm/support/identification/SCCS/s.access_group_ref.e $"
...
--| License.
--|
--| The Original Code is access_group_ref.e.
--|
