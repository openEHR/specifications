indexing
	...
	file:        "$Source: C:/project/openehr/spec-dev/architecture/computable/eiffel/rm/data_structures/structure/representation/SCCS/s.element.e $"
...
--| License.
--|
--| The Original Code is element.e.
--|
