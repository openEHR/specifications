indexing
	...
	file:        "$Source: C:/project/openehr/spec-dev/architecture/computable/eiffel/rm/demographic/SCCS/s.party_relationship.e $"
	revision:    "$Revision$"
	last_change: "$Date$"
...
--| License.
--|
--| The Original Code is party_relationship.e.
--|
