indexing
	...
	description: "Constrainer type for instances of DV_GENERAL_TIME_SPECIFICATION"
	...
	file:        "$Source: C:/project/openehr/spec-dev/architecture/computable/eiffel/am/data_types/time_specification/SCCS/s.c_dv_general_time_specification.e $"
	revision:    "$Revision$"
	last_change: "$Date$"
...
feature -- Access
	...
	default_value: DV_GENERAL_TIME_SPECIFICATION is
			-- 
		do
...
feature -- Status Report
	...
	valid_value (a_value: DV_GENERAL_TIME_SPECIFICATION): BOOLEAN is 
		do
		end
...
--| License.
--|
--| The Original Code is c_dv_general_time_specification.e.
--|
